...
CREATE DATABASE IF NOT EXISTS `cartorial` CHARACTER SET = 'utf8mb4' COLLATE = 'utf8mb4_unicode_ci';
USE `cartorial`;

----------------------------------------------------------------------
-- Tabla Usuarios
-- Se añade NOT NULL a 'email' para asegurar que cada usuario tiene un correo.
----------------------------------------------------------------------
CREATE TABLE `usuarios` (
  `id_usuario` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(100) NOT NULL,
  `apellidos` VARCHAR(150) DEFAULT NULL,
  `email` VARCHAR(255) NOT NULL UNIQUE, -- CORRECCIÓN: Añadido NOT NULL
...
----------------------------------------------------------------------
-- Tabla Vehiculos
-- Relación 1:N con Usuarios (id_usuario NOT NULL, ON DELETE CASCADE)
----------------------------------------------------------------------
...
-- Relación 1:N con Usuarios (id_usuario NOT NULL, ON DELETE CASCADE)
-- Relación 1:0..N con Vehiculos (id_vehiculo NULL, ON DELETE SET NULL)
----------------------------------------------------------------------
...
----------------------------------------------------------------------
-- Tabla Registros_km
-- Relación 1:N con Vehiculos (id_vehiculo NOT NULL, ON DELETE CASCADE)
----------------------------------------------------------------------
...
-- Tabla Gastos
-- Relación 1:N con Vehiculos (id_vehiculo NOT NULL, ON DELETE CASCADE)
-- Relación 1:0..N con Usuarios (id_usuario NULL, ON DELETE SET NULL)
----------------------------------------------------------------------
CREATE TABLE `gastos` (
